...
| **R08** | Information Disclosure | Archivos y rutas ocultas (`/.git/config`, `/.env`) exponían la estructura interna del repositorio y código fuente | Medio | Media | **Corregido** | `curl /.git/config` retorna HTTP 403 (`evidence/retest/hidden_path.txt`) | Directiva Nginx: `location ~ /\. { deny all; return 403; }` |
| **R09** | Information Disclosure | Exposición pública de direccionamiento IP de gestión interno (`10.0.X.X`), versiones de SO y ubicaciones de red | Alto | Alta | **Corregido** | Archivo sanitizado versionado en Git (`app/public-inventory.txt`) | Política de mínima exposición: disociación de catálogo público de equipos |
...
### 3. Solución Técnica Implementada y Verificación
...
- **Evidencia Reproducible:** Documentada en [evidence/retest/nmap_port80.nmap](file:///C:/Users/Daniel/.gemini/antigravity/scratch/Lab3-FDSI-lab/evidence/retest/nmap_port80.nmap) y [evidence/retest/headers_after.txt](file:///C:/Users/Daniel/.gemini/antigravity/scratch/Lab3-FDSI-lab/evidence/retest/headers_after.txt).
